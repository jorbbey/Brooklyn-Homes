...
const BlogHero = ({text, image}) => {
  return (
    <div className="relative text-white h-[75vh] lg:h-[100vh] bg-cover bg-center flex justify-center items-end" style={{ backgroundImage: `url(${image})` }}>
      <div className="absolute inset-0 bg-black opacity-25 mix-blend-multiply"></div>
      <div className="relative z-10 bg-black md:w-[70%] lg:w-1/2 p-5 my-0 lg:my-10 opacity-75">  
        <h1 className="text-white text-2xl md:text-3xl lg:text-5xl capitalize">
          {text}
        </h1>
      </div>
    </div>
