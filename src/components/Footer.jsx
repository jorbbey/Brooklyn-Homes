    ...
    <footer className="bg-[#333333]">
      <section className="flex flex-col md:flex-row justify-between items-start my-5">
        ...
        <div className="w-[90%] md:w-[30%] md:my-10 m-auto">
          <h1 className="m-auto w-1/2 md:w-[90%] my-5 text-lg lg:text-2xl text-white font-semibold text-center lg:text-left">
            Useful Links
          </h1>
          <ul className="m-auto w-[90%] my-4 text-gray-400 flex flex-col lg:flex-row justify-between items-center flex-wrap">
            <Link to="/about">
        ...
        <div className="w-[90%] md:w-[30%] border-t-1 md:border-t-0 md:border-l-1 border-gray-300 md:my-10 m-auto md:m-0">
          <h1 className="m-auto w-1/2 md:w-[90%] text-center lg:text-left my-5 text-lg lg:text-2xl text-white font-semibold">
            Follow Us
          </h1>
          <div className="m-auto w-1/2 md:w-[90%] my-4 text-white flex justify-start items-center mt-5 md:mb-48 lg:mb-38">
