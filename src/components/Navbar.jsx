    ...
    <header className="flex justify-between items-center">
      ...
      <nav className="hidden md:flex justify-around items-center">
        {menuItems.map((item) => (
          <div
            ...
            onMouseEnter={
              item.text === "Our Projects" ? handleMouseEnter : null
            }
            onMouseLeave={
              item.text === "Our Projects" ? handleMouseLeave : null
            }
          >
            <Link
              to={item.link}
      ...
      {isOpen && (
        <div
          ...
          ref={popupRef}
          onMouseLeave={handleMouseLeave} // Hide popup when leaving the popup
        >
