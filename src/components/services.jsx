...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      >
        <main className="flex flex-col md:flex-row flex-wrap items-center justify-between lg:justify-start my-5 mx-2 md:my-0 w-[95%] lg:w-[70%]">
          {services.map((item) => (
            <div
              key={item.head}
              className="text-center m-auto my-5 p-4 w-[90%] md:w-[35%] text-gray-950"
            >
