...
import m1 from "../assets/durumi-site1/DurumiSite1_1.jpg";
import m2 from "../assets/durumi-site1/DurumiSite1_2.jpg";
import m3 from "../assets/durumi-site1/DurumiSite1_3.jpg";
        ...
        <div className="w-[90%] lg:w-[50%] m-auto">
          ...
          <div className="">
            <p className="text-sm md:text-md leading-loose my-5 lg:my-10 text-gray-300">
              ...
              project. <br /> At Brooklyn Homes we don't just build properties,
              we build trust, peace of mind and legacies.
            </p>
