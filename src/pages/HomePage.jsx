            ...
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="w-[90%] lg:w-[45%] mx-3 mb-0">
                ...
                <p className="text-md leading-8 my-5 md:my-3 lg:my-5">
                  ...
                  satisfaction. <br /> Whether you’re seeking a luxurious home,
                  a smart investment, or top-tier property management, we’re
                  here to make it happen. <br /> Welcome to your future.
                </p>
              </div>
            </div>
