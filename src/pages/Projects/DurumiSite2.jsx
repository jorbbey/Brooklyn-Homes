        ...
        <section className="my-10 lg:my-40">
          <div className="flex flex-col lg:flex-row justify-around items-start my-5 lg:my-20">
            ...
            <p className="w-full lg:w-[60%] text-gray-300">
              ...
              cozy 2-bedroom flat. The estate boasts contemporary architecture,
              energy-efficient designs, lush communal green spaces, ample
              parking, and 24/7 security. Residents can enjoy top-tier
              amenities, including a fully equipped gym, a children's play area,
          ...
          <p className="my-5 text-sm">
            <span className="font-semibold text-[#bc963f]">Status:</span> Under
            construction, expected completion by Q4 2025.
          </p>
          <p className="my-5 text-sm">
